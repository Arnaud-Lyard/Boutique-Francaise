...
return [
    ...
    [ // $staticRoutes
        ...
        '/actualites' => [[['_route' => 'blog', '_controller' => 'App\\Controller\\BlogController::index'], null, null, null, false, false, null]],
    ...
    [ // $regexpList
        0 => '{^(?'
                ...
                .'|/a(?'
                    .'|ctualite/([^/]++)(*:488)'
                    .'|jouter\\-un\\-commentaire/([^/]++)(*:528)'
                .')'
                .'|/details_categorie/([^/]++)(*:564)'
                .'|/produit/([^/]++)(*:589)'
                .'|/modifier\\-mon\\-mot\\-de\\-passe/([^/]++)(*:636)'
            .')/?$}sDu',
    ],
    [ // $dynamicRoutes
        ...
        406 => [[['_route' => 'add_to_cart', '_controller' => 'App\\Controller\\CartController::add'], ['id'], null, null, false, true, null]],
        432 => [[['_route' => 'delete_to_cart', '_controller' => 'App\\Controller\\CartController::delete'], ['id'], null, null, false, true, null]],
        455 => [[['_route' => 'decrease_to_cart', '_controller' => 'App\\Controller\\CartController::decrease'], ['id'], null, null, false, true, null]],
        488 => [[['_route' => 'show', '_controller' => 'App\\Controller\\BlogController::show'], ['id'], null, null, false, true, null]],
        528 => [[['_route' => 'comment', '_controller' => 'App\\Controller\\CommentController::index'], ['id'], null, null, false, true, null]],
        564 => [[['_route' => 'categoryDetails', '_controller' => 'App\\Controller\\BlogController::showArticle'], ['id'], null, null, false, true, null]],
        589 => [[['_route' => 'product', '_controller' => 'App\\Controller\\ProductController::show'], ['slug'], null, null, false, true, null]],
        636 => [
