 ...
 */
class getCategoryArticleRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CategoryArticleRepository' shared autowired service.
     *
     * @return \App\Repository\CategoryArticleRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CategoryArticleRepository.php';

        return $container->privates['App\\Repository\\CategoryArticleRepository'] = new \App\Repository\CategoryArticleRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
