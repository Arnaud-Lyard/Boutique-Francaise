...
return [
    ...
    'blog' => [[], ['_controller' => 'App\\Controller\\BlogController::index'], [], [['text', '/actualites']], [], [], []],
    'show' => [['id'], ['_controller' => 'App\\Controller\\BlogController::show'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/actualite']], [], [], []],
    'categoryDetails' => [['id'], ['_controller' => 'App\\Controller\\BlogController::showArticle'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/details_categorie']], [], [], []],
    ...
    'comment' => [['id'], ['_controller' => 'App\\Controller\\CommentController::index'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/ajouter-un-commentaire']], [], [], []],
