...
/* blog/show.html.twig */
class __TwigTemplate_4d6ebe543c00a5a1c290fc9ca3d56b9d90d6656a886290e3fa550ce265c7ba55 extends Template
{
    private $source;
    private $macros = [];
...
<h1 class=\"title p-1\">";
        ...
        echo "</h1>
    <div class=\"img-fluid\">
        <img width=\"100%\" src=\"/uploads/articles/";
        // line 9
    ...
    <div class=\"content\">
        ...
        // line 12
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 12, $this->source); })()), "createdAt", [], "any", false, false, false, 12), "d/m/Y"), "html", null, true);
        echo " à ";
        ...
        // line 13
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 13, $this->source); })()), "user", [], "any", false, false, false, 13), "html", null, true);
        echo " </span></p>
        <h2 class=\"title\"> ";
        // line 14
        ...
        echo "\" class=\"btn btn-info\" style=\"text-decoration:none\">Retour à l'accueil</a>
</div>
";
    ...
    {
        return array (  104 => 17,  99 => 15,  95 => 14,  91 => 13,  85 => 12,  77 => 9,  72 => 7,  68 => 5,  58 => 4,  35 => 1,);
    }
...
<div class=\"container\">
<h1 class=\"title p-1\">{{ article.title }}</h1>
    <div class=\"img-fluid\">
        <img width=\"100%\" src=\"/uploads/articles/{{ article.image }}\" alt=\"{{ article.title }}\">
    </div>
    <div class=\"content\">
        <p class=\"date\">Ecrit le : {{ article.createdAt|date('d/m/Y') }} à {{ article.createdAt|date('H:i') }} 
        par <span class=\"author\"> {{ article.user }} </span></p>
        <h2 class=\"title\"> {{ article.title }} </h2>
        <p  class=\"content text-justify\">{{ article.content | raw}}</p>
    </div>
        <a href=\"{{ path('home') }}\" class=\"btn btn-info\" style=\"text-decoration:none\">Retour à l'accueil</a>
</div>
{% endblock %}", "blog/show.html.twig", "C:\\Développement\\Symfony\\laboutiquefrancaise\\templates\\blog\\show.html.twig");
    }
}
