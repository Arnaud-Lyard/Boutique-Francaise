...
class __TwigTemplate_9900fdca792165a295ec474aee6ecbfa631311de4e19b8840886a4e623728aaf extends Template
{
    private $source;
    private $macros = [];
...
{% block content %}
        ...
        {% for product in cart %}
            ...
            <td>
                <a href=\"{{ path('decrease_to_cart', {'id' : product.product.id }) }}\">
                    <img src=\"{{ asset('assets/img/minus.png') }}\" height=\"12px\" alt=\"Retirer un produit\">
                </a>
                x {{ product.quantity}}
    ...
    {% endif %}
{% endblock %}
", "cart/index.html.twig", "C:\\Développement\\Symfony\\laboutiquefrancaise\\templates\\cart\\index.html.twig");
    }
}
