...
class __TwigTemplate_71160cc6dc6afcad9c2efbfb52fa126458c08d494b6238205c3d2d0baf555fdc extends Template
{
    private $source;
    private $macros = [];
     ...
     <div class=\"row\">
        ...
        <div class=\"col-md-4\">
            <div class=\"account-item text-center\">
                <img src=\"";
        // line 23
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/img/address.png"), "html", null, true);
        ...
        <div class=\"col-md-4\">
            <div class=\"account-item text-center\">
                <img src=\"";
        // line 29
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/img/order.png"), "html", null, true);
...
";
    ...
    {
        return array (  137 => 30,  133 => 29,  125 => 24,  121 => 23,  113 => 18,  109 => 17,  100 => 11,  97 => 10,  93 => 8,  91 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block content %}
    ...
    Bienvenue {{ app.user.firstname }} dans votre compte.<br/>
     ...
     <div class=\"row\">
        ...
        <div class=\"col-md-4\">
            <div class=\"account-item text-center\">
                <img src=\"{{ asset('assets/img/address.png') }}\" alt=\"Gérer mes adresses\"><br/>
                 <a href=\"{{ path('account_address') }}\">Gérer mes adresses</a>
            </div>
        </div>
        <div class=\"col-md-4\">
            <div class=\"account-item text-center\">
                <img src=\"{{ asset('assets/img/order.png') }}\" alt=\"Mes commandes\"><br/>
                 <a href=\"{{ path('account_order') }}\">Mes commandes</a>
            </div>
        </div>
     </div>
{% endblock %}
", "account/index.html.twig", "C:\\Développement\\Symfony\\laboutiquefrancaise\\templates\\account\\index.html.twig");
    }
}
