...
class __TwigTemplate_fb74a6a092aa995e6ea56ef42cf0cc38a4f1a8028b5fdbee0eec2b9fb98dc799 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function getSourceContext()
    {
        ...
        <a href=\"{{ path('product', { 'slug' : product.slug } ) }}\"><img src=\"/uploads/products/{{ product.illustration }}\" alt=\"{{ product.name }}\" class=\"img-fluid\"></a>
        <h5>{{ product.name }}</h5>
        <span class=\"product-subtitle\">{{ product.subtitle }}</span>
        <span class=\"product-price\">{{ (product.price / 100)|number_format(2, ',', '.') }}</span>
    </div>
", "product/single_product.html.twig", "C:\\Développement\\Symfony\\laboutiquefrancaise\\templates\\product\\single_product.html.twig");
    }
}
